...
- **JSON構造化タグ生成**: AIによる英語→日本語のタグ生成をJSONスキーマで実装
  ...
  {
    "pairs": [
      {"en": "masterpiece", "ja": "傑作", "weight": 1.2, "category": "quality"},
      {"en": "blue eyes", "ja": "青い目", "weight": 1.0, "category": "appearance"}
    ]
  }
  ```
- **Split to Tags強化**: 機械的分割機能の完全実装（,と.での自動分割）
- **英⇄日完全連動**: タグ編集時の即時同期と翻訳機能
- **カテゴリ自動分類**: person/appearance/clothes/pose/background/quality/style/otherの8分類
